...
md"Define smoothing functions"

# ╔═╡ db8fb592-7120-11f0-2a69-b9d9d6d9da5f
function smooth_min(a::FT, b, m) where {FT}
    return convert(FT, 1 / 2) * (a + b - √((a - b)^2 + m))
end

# ╔═╡ 05b42b9d-40a4-40bd-be23-d753321da33f
function smooth_max(a::FT, b, m) where {FT}
    return convert(FT, 1 / 2) * (a + b + √((a - b)^2 + m))
end

# ╔═╡ 767b246e-46d7-4502-bd13-c82f661be871
function smooth_clamp(x::FT, lower, upper, m) where {FT}
    return smooth_min(smooth_max(x, lower, m), upper, m)
end

# ╔═╡ 8ed550cc-52c9-4e4e-96cd-97640a321334
lower = 0

# ╔═╡ a2289cfb-1426-4098-b9ff-018a045bc48d
upper = 1

# ╔═╡ 30c5cbbe-9e1f-471d-a3e3-87f91d1c851d
@bind m Slider(0.0001:0.0001:0.01)

# ╔═╡ bca74fd6-b7e7-4cd4-b9fb-740ccbd78ec0
m

# ╔═╡ b74f7211-e3cd-4e73-a43d-311cd88be830
x = -0.5:0.001:1.5

# ╔═╡ d283b18a-9f30-4e72-9158-c42ea22457b4
y_clamped = smooth_clamp.(x, lower, upper, m)

# ╔═╡ 3fd29a25-c756-4762-b58c-84dd3cebb3af
y_max = smooth_max.(x, lower, m)

# ╔═╡ 381a6ee9-55e0-456c-a3a6-f13cc88a1e3f
y_min = smooth_min.(x, upper, m)
...
# ╔═╡ 47616ff7-f297-4714-be4d-5a49b1168c37
md"For maximum value of surface resistance, there is also a need for a smooth min"

# ╔═╡ e8b5c861-d703-462d-b733-e3e455bff3f8
r_smax = 500_000
...
# ╔═╡ 1a23f463-2983-475f-a97e-1a6fc0b2024e
y_rs = smooth_min.(x_rs, 500_000.0, m_rs)

# ╔═╡ ed318a1f-e67f-424e-aa5d-61a7efeb3c7c
plot(x_rs, y_rs)
...
# ╔═╡ 0b70427a-b4df-4e30-b5f1-df089bf7410d
md"Here, a smoothing parameter with a value of $r_{s,max}$ seems okay"
