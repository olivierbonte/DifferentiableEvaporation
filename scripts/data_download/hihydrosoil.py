...
var_dict = {
    "N":"n","wcsat":"w_sat","wcres":"w_res",
    "wcpf2":"w_fc","wcpf3":"w_crit","wcpf4-2":"w_wp"
...
for site in sites:
    ...
    ds_hihydrosoil.depth.attrs["Description"] = "Intervals of soil depth below the surface"
    ...
    ds_hihydrosoil.attrs["url"] = "https://gee-community-catalog.org/projects/hihydro_soil/"
    ds_hihydrosoil.attrs["url_report"] = "https://www.futurewater.nl/wp-content/uploads/2020/10/HiHydroSoil-v2.0-" \
                                         "High-Resolution-Soil-Maps-of-Global-Hydraulic-Properties_v2.pdf"
    # Write to disk as NetCDF
    ds_hihydrosoil.to_netcdf(
        os.path.join(hihydrosoil_dir, site + ".nc")
    )
